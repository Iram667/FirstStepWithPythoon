...
Original file is located at
    https://colab.research.google.com/drive/1MZQSbFPSa0z5cddZoeFAYBf1SvvAtXcD
...
'''The symmetric_difference() method will return a new set, that are in either set, but not in the interection.'''
...
#Following are marks of a student in different subjects. Find his total obtained marks.
...
fruits = ["apple", "banana", "cherry", "mango", "apricort", "berries"]
#using for loop, make a new list having fruit names that start with an "a"
...
def sum_two(a, b):
  c = a + b
  return c
x = sum_two(11.5 , 22.4)   #x = return value(c)
print(x)
...
def myfunction(a, z , b ):
  print("Hello")
  c = a + b + z
  # print("Hello")
  # print("I'm a function :)")
  return c
c = myfunction(a = 2,z = 10, b = 23)
print(c)
myfunction(11,22,34)
print("Python")
